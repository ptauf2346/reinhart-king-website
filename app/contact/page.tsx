...
export default async function ContactPage(){
    ...
    return(
        <div className="w-3/4 mx-auto">
            ...
            <br></br>
            <div>
                <h1 className="text-2xl text-blue-900 py-3">Cynthia A. Reinhart-King</h1>
                <h3 className="text-lg py-1"><u>Lab Address</u></h3>
                <p>{contact_info.address}</p>
                <h3 className="text-lg py-1"><u>Email</u></h3>
                <p>{contact_info.email}</p>
                <h3 className="text-lg py-1"><u>Phone Number</u></h3>
                <p>{contact_info.phone}</p>
                <h3 className="text-lg py-1"><u>Mail Address</u></h3>
                <p>{contact_info.mail}</p>
            </div>
            <div>
                <h1 className="text-2xl text-blue-900 py-3">Prospective Applicants</h1>
                <h3 className="text-xl text-red-900 py-1">Undergraduate Students:</h3>
                <p>Undergraduates interested in working in the lab should send Dr. Reinhart-King a resume and a recent transcript.</p>
                <h3 className="text-xl text-red-900 py-1">Prospective Graduate Students:</h3>
                ...
                <h3 className="text-xl text-red-900 py-1">Prospective Postdoctoral Associates:</h3>
